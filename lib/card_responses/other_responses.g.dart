...
Map<String, dynamic> _$FileHashDataHexToJson(FileHashDataHex instance) =>
    <String, dynamic>{
...
ReadFilesResponse _$ReadFilesResponseFromJson(Map<String, dynamic> json) {
  return ReadFilesResponse(
    (json['files'] as List)
        ?.map((e) =>
            e == null ? null : FileHex.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}
...
Map<String, dynamic> _$ChangeFileSettingsToJson(ChangeFileSettings instance) =>
    <String, dynamic>{
      'fileIndex': instance.fileIndex,
